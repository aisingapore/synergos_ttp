...
- `path_to_cabbage_price_dataset/cabbage_price`
```
cabbage_price
└───data1
│   └───train
...
```
$ pysyft_worker > docker run -v path_to_cabbage_price_dataset/cabbage_price/data1:/worker/data -v path_to_outputs/outputs_1:/worker/outputs --name worker_1 worker:pysyft_demo

$ pysyft_worker > docker run -v path_to_cabbage_price_dataset/cabbage_price/data1:/worker/data -v path_to_outputs/outputs_2:/worker/outputs --name worker_2 worker:pysyft_demo
```
