...
expt_id_1   = "text_experiment_1"  # 1st expt declared to test out default functions
expt_id_2   = "text_experiment_2"  # 2nd expt to test for expt-level bulk testing
run_id_1    = "text_run_1"         # 1nd run to test for run-level bulk testing (linked to "test_experiment_1")
run_id_2    = "text_run_2"         # 2nd run to test for run-level bulk testing (linked to "test_experiment_2")
run_id_3    = "text_run_3"         # 3nd run to test for run-level bulk testing (linked to "test_experiment_2")
